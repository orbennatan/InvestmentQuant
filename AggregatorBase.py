...
class AggregatorBase(BaseClass):
    ...
    def input_owner_name(self)->str:
        # prompt user to enter the owner using a number. Print the names with the ordinal numbers and ask for a single digit to be entereed
        # Tell the user 0 means we are done updating and it is time to quit the program.
        pass
